	...
	var ElementQueries = function () {
		...
		function convertToPx(element, value) {
			...
			switch (units) {
				...
				case "vh":
					return (
						(value * document.documentElement.clientHeight) / 100
					);
				case "vmin":
				case "vmax":
		...
		function setupElement(element, id) {
			...
			if (!element.elementQueriesSensor) {
				element.elementQueriesSensor = new ResizeSensor(
					element,
					function () {
				...
				if (lastActiveImage !== imageToDisplay) {
					...
					if (!loadedImages[imageToDisplay]) {
						...
						image.onload = function () {
							children[imageToDisplay].src =
								sources[imageToDisplay];
		...
		this.init = function () {
			...
			if (
				...
				typeof document.documentElement.style["OAnimationName"] !==
				"undefined"
			) {
			...
			document.body.addEventListener(animationStart, function (e) {
				...
				var animationName =
					styles && styles.getPropertyValue("animation-name");
				var requiresSetup =
					animationName &&
					-1 !== animationName.indexOf("element-queries");
