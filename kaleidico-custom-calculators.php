...
function kaleidico_custom_calculators_enqueue_scripts()
{
    ...
    if (has_shortcode($post->post_content, 'fha_calculator') || has_shortcode($post->post_content, 'mortgage-payment-calculator') || has_shortcode($post->post_content, 'affordability_calculator')) {
