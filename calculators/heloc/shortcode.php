...
function kaleidico_heloc_calculator_shortcode($atts)
{
    ...
    ob_start();
?>
    <div class="heloc-container-query-wrapper">
        <div class="kaleidico-calculator heloc-calculator">
            <div class="heloc-calculator-container">
              ...
              We'll display the Loan Amount, Draw Period Payment, Repayment Period Payment 
            -->
                    ...
                    <hr class="loc-separator">
                    <!-- Tabs for Chart, Table, and Amortization -->
                    <div class="heloc-tabs">
                        <ul class="heloc-tab-toggles">
                            <li class="active" data-tab="chart-view"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                            ...
                            <li data-tab="table-view"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                            ...
                            <li data-tab="amort-view"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
