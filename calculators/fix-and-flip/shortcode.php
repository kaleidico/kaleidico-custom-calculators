...
function kaleidico_fix_flip_calculator_shortcode( $atts ) {
	...
	<div class="kaleidico-calculator fix-and-flip-calculator">
		...
		<div class="calculator-white-section">
			...
			<div class="input-group">
				<div class="label-container">
					<label for="transfer_tax_percentage_ff">Transfer Tax<br><small>(Multiplier)</small></label>
					<span class="tooltip-group">
		...
		<div class="calculator-grey-section">
			...
			<div class="calculator-results-advanced-container" style="display:none;">
				<div class="calculator-results-advanced">
					<!-- Column 1 -->
					<div class="lc">
						<div class="advanced-row"><div class="advanced-label">Net Profit</div>              <div class="advanced-total"><span id="net_profit"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">Total Cash Invested</div>    <div class="advanced-total"><span id="total_cash_invested"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">Loan Amount</div>             <div class="advanced-total"><span id="loan_amount"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">Monthly Loan Payment</div>    <div class="advanced-total"><span id="monthly_loan_repayment"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">Closing Costs</div>           <div class="advanced-total"><span id="closing_costs"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">Total Property Tax</div>      <div class="advanced-total"><span id="total_property_taxes"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">Transfer Tax</div>            <div class="advanced-total"><span id="transfer_tax"></span></div></div>
					</div>

					<!-- Column 2 -->
					<div class="rc">
						<div class="advanced-row"><div class="advanced-label">ROI</div>                     <div class="advanced-total"><span id="roi"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">ROE</div>                     <div class="advanced-total"><span id="roe"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">Down Payment</div>            <div class="advanced-total"><span id="down_payment"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">Loan Interest Repaid</div>    <div class="advanced-total"><span id="loan_interest"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">Realtor Fee</div>             <div class="advanced-total"><span id="realtor_fee"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">Total Insurance</div>         <div class="advanced-total"><span id="total_insurance"></span></div></div>
						<div class="advanced-row"><div class="advanced-label">Origination Fee</div>         <div class="advanced-total"><span id="origination_fee"></span></div></div>
					</div>
				</div>
			</div>
