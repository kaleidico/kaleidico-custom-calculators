...
function kaleidico_fix_flip_calculator_shortcode($atts)
{
    ...
    <div class="kaleidico-calculator fix-and-flip-calculator">
        ...
        <div class="calculator-white-section">
            ...
            <?php
            /* helper for repeated currency inputs */
            function ff_currency_input($name, $label, $value, $tooltip_field, $icon_class)
            { ?>
            ...
            /* ----- after‑repair value ----- */
            ff_currency_input(
                'after_repair_value_ff',
                'After Repair Value',
                $attr['after_repair_value_ff'],
                'after_repair_value_tt',
            ...
            <div class="input-group">
                <div class="label-container">
                    <label for="closing_costs_percentage_ff_coy">Origination Fee (%)</label>
                    <span class="tooltip-group">
                        <i class="fa fa-info-circle tooltip-icon origination-fee-tooltip-click" aria-hidden="true"></i>
                        <div class="origination-fee-tooltip tooltip"><?php the_field('origination_fee_tt', 'option'); ?></div>
                    </span>
                </div>
                <div class="input-container">
                    <input type="text" name="closing_costs_percentage_ff_coy" class="input-percentage" value="<?= esc_attr($attr['closing_costs_percentage_ff_coy']); ?>" />
                    <span class="percentage-sign">%</span>
                </div>
                <div class="slider-container">
                    <input type="range" name="closing_costs_percentage_ff_coy_slider" class="input-range" min="1" max="5" step="0.5" value="<?= esc_attr($attr['closing_costs_percentage_ff_coy']); ?>">
                </div>
            </div>

            <!-- Realtor Fee, Transfer Tax, Turnaround Time, Insurance, Taxes … -->
            <?php
            /* percentage helper */
            function ff_percent_input($name, $label, $value, $tooltip_field, $icon_class, $min, $max, $step)
            { ?>
                <div class="input-group">
                    <div class="label-container">
                        <label for="<?= esc_attr($name); ?>"><?= esc_html($label); ?></label>
            ...
            /* Transfer tax multiplier (number, not %) */
            ?>
            <div class="input-group">
                <div class="label-container">
            ...
            <!-- Insurance + Taxes (per month) -->
            <?php
            ff_currency_input(
                'property_insurance_per_month_ff',
                'Property Insurance (per Month)',
                $attr['property_insurance_per_month_ff'],
                'property_insurance_tt',
                'property-insurance-tooltip'
            );
            ff_currency_input(
                'property_taxes_per_month_ff',
                'Property Taxes (per Month)',
                $attr['property_taxes_per_month_ff'],
                'property_taxes_tt',
                'property-taxes-tooltip'
            );
            ?>
        </div><!-- /.calculator-white-section -->
        ...
        <div class="calculator-grey-section">
            ...
            <!-- ADVANCED RESULTS (hidden by default) -->
            <div class="calculator-results-advanced-container" style="display:none;">
                <div class="calculator-results-advanced">
                    <!------ COLUMN 1 ------>
                    <div class="lc">
                        <div class="advanced-row">
                            <div class="advanced-label">Net Profit</div>
                            <div class="advanced-total"><span id="net_profit"></span></div>
                        </div>
                        <div class="advanced-row">
                            <div class="advanced-label">Total Cash Invested</div>
                            <div class="advanced-total"><span id="total_cash_invested"></span></div>
                        </div>
                        <div class="advanced-row">
                            <div class="advanced-label">Loan Amount</div>
                            <div class="advanced-total"><span id="loan_amount"></span></div>
                        </div>
                        <div class="advanced-row">
                    ...
                    <div class="rc">
                        <div class="advanced-row">
                            <div class="advanced-label">ROI</div>
                            <div class="advanced-total"><span id="roi"></span></div>
                        </div>
                        <div class="advanced-row">
                            <div class="advanced-label">ROE</div>
                            <div class="advanced-total"><span id="roe"></span></div>
                        </div>
                        <div class="advanced-row">
                            <div class="advanced-label">Down Payment</div>
                            <div class="advanced-total"><span id="down_payment"></span></div>
                        </div>
                        <div class="advanced-row">
            ...
            <?php endif; ?>
        </div><!-- /.calculator-grey-section -->
    </div><!-- /.kaleidico-calculator -->
